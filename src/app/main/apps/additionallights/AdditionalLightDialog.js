...
function AdditionalLightDialog(props)
{
   const dispatch = useDispatch();
   const additionallightDialog = useSelector(({additionallightsApp}) => additionallightsApp.additionallights.additionallightDialog);
   ...
   const initDialog = useCallback(
      () => {
         if ( additionallightDialog.type === 'edit' && additionallightDialog.data )
         {
            setForm({...additionallightDialog.data});
         }

         if ( additionallightDialog.type === 'new' )
         {
            setForm({
               ...defaultFormState,
               ...additionallightDialog.data,
               id: FuseUtils.generateGUID()
            });
         }
      },
      [additionallightDialog.data, additionallightDialog.type, setForm]
   );
   ...
   useEffect(() => {
      ...
      * After Dialog Open
      */
      if ( additionallightDialog.props.open ) {
         initDialog();
      }

   }, [additionallightDialog.props.open, initDialog]);

   function closeComposeDialog()
   {
      additionallightDialog.type === 'edit' ? dispatch(Actions.closeEditAdditionalLightDialog()) : dispatch(Actions.closeNewAdditionalLightDialog());
   }
   ...
   function handleSubmit(event)
   {
      ...
      if ( additionallightDialog.type === 'new' ) {
         dispatch(Actions.addAdditionalLight(form));
      } else {
         dispatch(Actions.updateAdditionalLight(form));
      }
   ...
   {
      dispatch(Actions.removeAdditionalLight(form._id));
      closeComposeDialog();
   }
   ...
   return (
      ...
      >
         ...
         <AppBar position="static" elevation={1}>
            <Toolbar className="flex w-full">
               <Typography variant="subtitle1" color="inherit">
                  {additionallightDialog.type === 'new' ? 'New Additional Light' : 'Edit Additional Light'}
               </Typography>
            </Toolbar>
            <div className="flex flex-col items-center justify-center pb-24">
               {additionallightDialog.type === 'edit' && (
                  <>
         ...
         <form noValidate onSubmit={handleSubmit} className="flex flex-col md:overflow-hidden">
            ...
            {additionallightDialog.type === 'new' ? (
...
export default AdditionalLightDialog;
