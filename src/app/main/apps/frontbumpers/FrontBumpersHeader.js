...
function FrontBumpersHeader(props)
{
         ...
         <div className="flex flex-shrink items-center sm:w-224">
            ...
            <div className="flex items-center">
               ...
               <FuseAnimate animation="transition.slideLeftIn" delay={300}>
                  <Typography variant="h6" className="hidden sm:flex">Front Bumpers</Typography>
               </FuseAnimate>
            </div>
         </div>
            ...
            <Fab
               ...
               onClick={ev => {
                  if (vehicleTypes.length === 0) {
                     ...
                     dispatch(Actions.openNewFrontBumperDialog());
                  }
               }}
            >
               <Icon>add</Icon>
...
export default FrontBumpersHeader;
