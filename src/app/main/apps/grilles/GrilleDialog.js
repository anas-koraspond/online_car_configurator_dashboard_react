...
function GrilleDialog(props)
{
   ...
   const initDialog = useCallback(
      () => {
         if ( grilleDialog.type === 'edit' && grilleDialog.data )
         {
            setForm({...grilleDialog.data});
         }

         if ( grilleDialog.type === 'new' )
         {
            setForm({
               ...defaultFormState,
               ...grilleDialog.data,
      ...
      [grilleDialog.data, grilleDialog.type, setForm]
   );
   ...
   useEffect(() => {
      ...
      * After Dialog Open
      */
      if ( grilleDialog.props.open ) {
         initDialog();
      }

   }, [grilleDialog.props.open, initDialog]);

   function closeComposeDialog()
   {
      grilleDialog.type === 'edit' ? dispatch(Actions.closeEditGrilleDialog()) : dispatch(Actions.closeNewGrilleDialog());
   }
   ...
   function handleSubmit(event)
   {
      ...
      if ( grilleDialog.type === 'new' ) {
         dispatch(Actions.addGrille(form));
      } else {
         dispatch(Actions.updateGrille(form));
      }
   ...
   {
      dispatch(Actions.removeGrille(form._id));
      closeComposeDialog();
   }
         ...
         <AppBar position="static" elevation={1}>
            <Toolbar className="flex w-full">
               <Typography variant="subtitle1" color="inherit">
                  {grilleDialog.type === 'new' ? 'New Grille' : 'Edit Grille'}
               </Typography>
            </Toolbar>
            <div className="flex flex-col items-center justify-center pb-24">
               {grilleDialog.type === 'edit' && (
                  <>
